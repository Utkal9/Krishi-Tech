                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                {isEditing ? (
                                    <input
                                        type="number"
                                        value={
                                            editData?.farmDetails.totalArea ||
                                            ""
                                        }
                                        onChange={(e) =>
                                            setEditData((prev) =>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {farmerProfile.farmDetails.irrigationType.map(
                                        (method) => (
                                            <span
                                                key={method}
                                    ...
                                    {farmerProfile.farmDetails.irrigationType
                                        .length === 0 && (
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {farmerProfile.farmDetails.currentCrops.map(
                                        (crop) => (
                                            <span
                                                key={crop}
                            ...
                            <div>
                                <label className="flex items-center space-x-2">
                                    ...
                                    <span className="text-sm text-gray-700">
                                        Receive notifications about weather and
                                        market alerts
                                    </span>
                                </label>
                            </div>
