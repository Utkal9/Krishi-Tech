...
const HomePage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchWeatherAndTip = async () => {
            ...
            try {
                ...
                const locationName =
                    farmerProfile.farmLocation.district || "your region";
                ...
                setWeatherData((prev) => ({
                    ...prev,
                    loading: false,
                    error: t("errors.weather_load_failed"),
                }));

                setFarmingTip((prev) => ({
                    ...prev,
                    loading: false,
                    error: t("errors.tip_load_failed"),
                }));
            }
        };

        fetchWeatherAndTip();
    }, [farmerProfile?.farmLocation, t]);

    // Define arrays inside the component to use the 't' function
    const quickActions = [
        {
            title: t("quick_actions.soil_analysis_title"),
            description: t("quick_actions.soil_analysis_desc"),
            icon: TestTube,
        ...
        {
            title: t("quick_actions.weather_title"),
            description: t("quick_actions.weather_desc"),
            icon: Cloud,
        ...
        {
            title: t("quick_actions.recommendations_title"),
            description: t("quick_actions.recommendations_desc"),
            icon: Sprout,
        ...
        },
        {
            ...
            description: t("quick_actions.market_insights_desc"),
            icon: TrendingUp,
        ...
        {
            title: t("quick_actions.disease_detection_title"),
            description: t("quick_actions.disease_detection_desc"),
            icon: Activity,
    ...
    const farmingTips = [
        {
            id: 1,
            title: t("farming_tips.irrigation_title"),
            content: t("farming_tips.irrigation_content"),
            category: t("farming_tips.irrigation_category"),
        },
        {
            id: 2,
            title: t("farming_tips.ph_title"),
            content: t("farming_tips.ph_content"),
            category: t("farming_tips.ph_category"),
        },
        {
            id: 3,
            title: t("farming_tips.rotation_title"),
            content: t("farming_tips.rotation_content"),
            category: t("farming_tips.rotation_category"),
        },
    ];
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        >
                            ...
                            <span>{t("homepage.check_plant_health")}</span>
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-gray-800">
                                {t("homepage.identify_diseases_quickly")}
                            </h3>
                            <p className="text-gray-600">
                                {t("homepage.identify_diseases_desc")}
                            </p>
                            <div className="space-y-3 mt-4">
                                <div className="flex items-start">
                                    ...
                                    <span className="text-gray-700">
                                        {t(
                                            "homepage.feature_instant_detection"
                                        )}
                                    </span>
                                </div>
                                <div className="flex items-start">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 mr-2 flex-shrink-0" />
                                    <span className="text-gray-700">
                                        {t("homepage.feature_treatment_recs")}
                                    </span>
                                </div>
                                <div className="flex items-start">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 mr-2 flex-shrink-0" />
                                    <span className="text-gray-700">
                                        {t("homepage.feature_prevention_tips")}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-500">
                                    {t("homepage.example_leaf_caption")}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <h3 className="font-semibold text-red-900 mb-1">
                                {t("homepage.weather_alert")}
                            </h3>
                            <p className="text-sm text-red-700 mb-2">
                                {t("homepage.heavy_rainfall_warning")}
                            </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                        <div className="text-center">
                            ...
                            <h4 className="font-semibold text-gray-900 mb-2">
                                {t("homepage.crop_calendar")}
                            </h4>
                            <p className="text-sm text-gray-600">
                                {t("homepage.crop_calendar_desc")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                        <div className="text-center">
                            ...
                            <h4 className="font-semibold text-gray-900 mb-2">
                                {t("homepage.expert_advice")}
                            </h4>
                            <p className="text-sm text-gray-600">
                                {t("homepage.expert_advice_desc")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                        <div className="text-center">
                            ...
                            <h4 className="font-semibold text-gray-900 mb-2">
                                {t("homepage.yield_tracking")}
                            </h4>
                            <p className="text-sm text-gray-600">
                                {t("homepage.yield_tracking_desc")}
                            </p>
                        </div>
                    </div>
                </div>
